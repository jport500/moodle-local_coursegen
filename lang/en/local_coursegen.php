...
$string['depth_comprehensive'] = 'Comprehensive — thorough, many sections';
$string['depth_standard'] = 'Standard — moderate length';
...
$string['field_audiencelevel'] = 'Audience level';
$string['field_audiencelevel_help'] = 'Who the course is pitched at. Beginner assumes no prior knowledge and phrases objectives at recall/understand; Intermediate assumes a foundation and aims at apply/analyse; Advanced assumes working expertise and aims at analyse/evaluate. This shapes the generated blueprint and any section you regenerate.';
$string['field_coursedescription'] = 'Course description';
$string['field_coursetitle'] = 'Course title';
$string['field_depth'] = 'Length and depth';
$string['field_depth_help'] = 'How much course to generate. Brief targets a few focused sections with lighter assessment; Standard a moderate course; Comprehensive a thorough course with more sections and fuller assessment. The model still adapts to what your source material supports.';
$string['field_generate'] = 'Create job';
$string['field_headerbanner'] = 'Generate an intro header banner';
$string['field_headerbanner_help'] = 'Optionally generate a wide AI title banner for the course\'s Introduction section header. AI rendering of title text is hit-or-miss; you can regenerate the banner from the job page if it comes out poorly. Counts as one image against the generation image cap.';
...
$string['hub_hidearchived'] = 'Hide archived';
$string['hub_noarchived'] = 'No archived jobs in this category.';
$string['hub_nojobs'] = 'No generation jobs in this category yet. Create one to get started.';
$string['hub_showarchived'] = 'Show archived';
...
$string['job_archive_button'] = 'Delete this job…';
$string['job_archive_confirm'] = 'Delete (archive) this job?';
$string['job_archive_explain'] = 'The job is archived — moved out of the active list but kept, with its cost and history, so you can restore it later. The generated course is left untouched unless you choose the option below.';
$string['job_archived_badge'] = 'Archived';
$string['job_archived_notice'] = 'This job is archived. It stays out of the active list until you restore it.';
$string['job_archived_ok'] = 'Job archived. You can restore it from the archived view.';
$string['job_coursedeleted_badge'] = 'Course deleted';
$string['job_coursedeleted_notice'] = 'The generated course was deleted. This job is kept for its record and cost; there is no course to open.';
$string['job_delete_cancel'] = 'Cancel';
$string['job_delete_submit'] = 'Delete job';
$string['job_deletecourse_option'] = 'Also permanently delete the generated course';
$string['job_deletecourse_override'] = 'I understand the learner data above will be permanently destroyed — delete the course anyway';
$string['job_deletecourse_warning'] = 'Warning: this course has learner activity — {$a}. Deleting it will permanently destroy that learner data. This cannot be undone.';
$string['job_deleted_withcourse_ok'] = 'Job archived and the generated course was deleted.';
$string['job_unarchive_button'] = 'Restore this job';
$string['job_unarchived_ok'] = 'Job restored to the active list.';
$string['jobdepth'] = 'Requested: {$a->level} · {$a->depth}';
...
$string['landing_admin'] = 'Course builder';
$string['landing_heading'] = 'Course builder';
$string['landing_intro'] = 'Choose a category to build a course in:';
$string['landing_none'] = 'You don\'t have course-builder access in any category yet. Ask an administrator to grant it, then start a build from the category\'s settings menu.';
$string['level_advanced'] = 'Advanced — assumes working expertise';
$string['level_beginner'] = 'Beginner — assumes no prior knowledge';
$string['level_intermediate'] = 'Intermediate — assumes a foundation';
...
$string['regenbanner_button'] = 'Regenerate header banner';
$string['regenbanner_failed'] = 'Could not regenerate the header banner; the existing one was kept.';
$string['regenbanner_success'] = 'Header banner regenerated. Reopen the course to see it.';
$string['regenimage_button'] = 'Regenerate image';
$string['regenimage_failed'] = 'Could not regenerate the image for section {$a}; the existing image was kept.';
$string['regenimage_success'] = 'Image for section {$a} regenerated. Reopen the course to see it.';
...
$string['section_heading_titled'] = 'Section {$a->no}: {$a->title}';
...
$string['setting_default_audience_level'] = 'Default audience level';
$string['setting_default_audience_level_desc'] = 'The audience level new generation jobs start with. Operators can change it per job unless you decide otherwise in your process.';
$string['setting_default_depth'] = 'Default length and depth';
$string['setting_default_depth_desc'] = 'The length/depth new generation jobs start with. Operators can change it per job.';
