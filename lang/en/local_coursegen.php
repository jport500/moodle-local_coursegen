...
$string['setting_wrap_mucertify'] = 'Wrap in certification';
$string['setting_wrap_mucertify_desc'] = 'When materializing a course, also create a tool_mucertify certification linked to its program, so completing the program earns the certification. Requires "Wrap in program". Off by default.';
$string['setting_wrap_muprog'] = 'Wrap in program';
$string['setting_wrap_muprog_desc'] = 'When materializing a course, also create a tool_muprog program containing it. Learners are not allocated automatically — configure the program\'s allocation sources afterwards. Off by default.';
