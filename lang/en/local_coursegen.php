...
$string['setting_cap_period_spend_desc'] = 'Hard cap on generation spend per period, in generation units (roughly four characters per token). Materialization is blocked when a job\'s estimate would exceed the remaining budget. Administrators can raise it.';
